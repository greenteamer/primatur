...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryDestination.body_all'
        db.add_column(u'country_countrydestination', 'body_all',
    ...
    def backwards(self, orm):
        # Deleting field 'CountryDestination.body_all'
        db.delete_column(u'country_countrydestination', 'body_all')
